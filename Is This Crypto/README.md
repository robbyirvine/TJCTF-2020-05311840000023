...
Huruf yang digunakan adalah huruf latin yang "unik". 
1. Gunakan [website](https://cryptii.com/pipes/caesar-cipher) untuk mendecode. 
2. Dengan metode `Alphabetical Substitution`, masukkan plaintext alphabet dan chiper aplhabet dengan huruf [unik](https://jrgraphix.net/r/Unicode/00A0-00FF). Kemudian akan didapat flagnya.
